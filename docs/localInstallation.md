...
- [OpenSILEX PHIS Deployment](#opensilex-phis-deployment)
  ...
  - [1. Prerequisite](#1-prerequisite)
    ...
    - [Software](#software)
      ...
      - [Apache Tomcat and RDF4J](#apache-tomcat-and-rdf4j)
        ...
        - [Apache Tomcat configuration](#apache-tomcat-configuration)
        - [RDF4J](#rdf4j)
      - [Apache2](#apache2)
  ...
  - [2. OpenSILEX PHIS Installation](#2-opensilex-phis-installation)
    ...
    - [PostgreSQL database](#postgresql-database)
      - [Create the opensilex user](#create-the-opensilex-user)
      - [Create the database](#create-the-database)
      - [Create the PostGIS extension](#create-the-postgis-extension)
      - [Set up the database](#set-up-the-database)
      - [Initialising Users](#initialising-users)
    - [Web Service](#web-service)
      ...
      - [Check web service](#check-web-service)
  ...
  - [3. Common errors](#3-common-errors)
    ...
    - [Errors with the web application](#errors-with-the-web-application)
      - [Other problems with the webapp and the web service](#other-problems-with-the-webapp-and-the-web-service)
